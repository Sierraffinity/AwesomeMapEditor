...
namespace ame
{
    ...
    //
    ///////////////////////////////////////////////////////////
    QList<Tileset *> TilesetManager::m_Tilesets;
    ...
    //
    ///////////////////////////////////////////////////////////
    void TilesetManager::add(Tileset *tileset)
    {
    ...
    //
    ///////////////////////////////////////////////////////////
    Tileset *TilesetManager::get(UInt32 offset)
    {
        int size = m_Tilesets.size();
        for (int i = 0; i < size; i++)
            if (m_Tilesets.at(i)->offset() == offset)
                return m_Tilesets[i];
